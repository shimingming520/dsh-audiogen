			...
			model_params: {
				...
				additionalProperties: {
					...
					properties: {
						format: {
							type: "string",
							description: "Output format override (mp3/wav/pcm…)."
						},
						duration: {
							type: "number",
						...
						speed: {
							type: "number",
							description: "Speed override."
						},
						emotion: {
							type: "string",
							description: "MiniMax emotion override."
						},
						vol: {
							type: "number",
							description: "MiniMax volume override."
						},
						pitch: {
							type: "integer",
							description: "MiniMax pitch override."
						},
						sample_rate: {
							type: "integer",
							description: "MiniMax sample rate override."
						},
						bitrate: {
							type: "integer",
							description: "MiniMax bitrate override."
						},
						lyrics: {
							type: "string",
							description: "Music lyrics override."
						},
						is_instrumental: {
							type: "boolean",
							description: "Instrumental override."
						},
						loop: {
							type: "boolean",
							description: "ElevenLabs loop override."
						},
						prompt_influence: {
							type: "number",
							description: "ElevenLabs prompt influence override."
						},
						seed: {
							type: "integer",
							description: "Stable Audio seed override."
						},
						steps: {
							type: "integer",
							description: "Stable Audio steps override."
						},
						cfg_scale: {
							type: "number",
							description: "Stable Audio cfg_scale override."
						},
						subtitle_enable: {
							type: "boolean",
							description: "MiniMax subtitle override."
						},
						aigc_watermark: {
							type: "boolean",
							description: "MiniMax watermark override."
						},
						language_boost: {
							type: "string",
							description: "MiniMax language boost override."
						}
					}
				},
